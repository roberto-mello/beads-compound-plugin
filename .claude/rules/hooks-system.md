...
1. **SessionStart**: `auto-recall.sh` - Searches knowledge based on open/in-progress beads, extracts keywords from bead titles and git branch, injects top 10 relevant entries
...
```bash
bd comment add {BEAD_ID} "LEARNED|DECISION|FACT|PATTERN|INVESTIGATION: ..."
```
