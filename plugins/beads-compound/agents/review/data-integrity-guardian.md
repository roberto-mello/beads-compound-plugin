...
description: "Reviews database migrations, data models, and code that manipulates persistent data. Checks migration safety, validates data constraints, ensures correct transaction boundaries, verifies referential integrity, and audits privacy compliance (GDPR/CCPA)."
model: inherit
---
