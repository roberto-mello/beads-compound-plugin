...
description: "Use PROACTIVELY when design work isn't coming together on the first attempt. If 1-2 design changes still feel off, use this agent with 5x or 10x iterations to systematically screenshot, analyze, and refine visual design through progressive improvement cycles. Also use when explicitly asked to iterate on a design."
color: violet
model: sonnet
---
